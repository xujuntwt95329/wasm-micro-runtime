...
if (WAMR_BUILD_JIT EQUAL 1)
  ...
  if (WAMR_BUILD_LW_JIT EQUAL 1)
    add_definitions("-DWASM_ENABLE_LW_JIT=1")
    include_directories(${DEPS_DIR}/mir)
    file (GLOB MIR_SOURCE
      ${DEPS_DIR}/mir/mir-gen.c
      ${DEPS_DIR}/mir/mir.c
      ${DEPS_DIR}/mir/llvm2mir/llvm2mir.c
    )
    # set (CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wno-abi -fsigned-char -fno-tree-sra -fno-ipa-cp-clone")
  endif ()
else ()
...
if (WAMR_BUILD_LW_JIT EQUAL 1)
  message ("     WAMR LIGHTWEIGHT JIT enabled")
else ()
  message ("     WAMR LIGHTWEIGHT JIT disabled")
endif ()
